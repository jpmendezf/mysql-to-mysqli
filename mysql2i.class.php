<?php
  /*
mysql2i.class.php versión 1.5
    
    #estructura de declaración fija para admitir versiones heredadas de PHP anteriores a 5.5
    #mysql_result actualizado
    # mysql_fetch_object fijo para que el tercer parámetro sea una matriz predeterminada
    
    versión 1.0
    
    Versión inicial
    
    Esta clase se libera al dominio público sin derechos de autor.
  */
  class mysql2i{
